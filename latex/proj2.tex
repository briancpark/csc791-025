...
\maketitle
%Apply at least three of the quantization methods in the list of NNI Quantizer to one of the example models in this repository. Hint: this model can be trained quickly; but you don't have to use this one. In the application of a quantization method, try at least two different configurations to see the differences in the result model and model speed and accuracy.
